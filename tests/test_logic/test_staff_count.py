...
from src.logic.staff_count import DayCount, calc_day_count, count_for_zone, overlap_hours
...
def _calc(date, shifts, wd_day=WD_DAY, wd_night=WD_NIGHT,
          we_day=WE_DAY, we_night=WE_NIGHT, rules=None):
    return calc_day_count(
        date, shifts,
        DAY_START, DAY_END, NIGHT_START, NIGHT_END, THRESHOLD,
        wd_day, wd_night, we_day, we_night,
        rules,
    )
